...
**Navigate to [http://10.10.183.251/](http://10.10.183.251/) in your browser and click on the "Reflected XSS" tab on the navbar;craft a reflected XSS payload that will cause a popup saying "Hello".**
